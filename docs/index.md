...
- **Tutorials** — step-by-step walkthroughs of the core renderers: rotation, layered PyMOL, secondary-structure topology.
- **Gallery** — publication-style examples mixing the renderers: experimental-vs-AlphaFold superposition with pLDDT coloring, sequence-alignment views tied to structure, multi-panel composite figures.
